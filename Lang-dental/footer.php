<footer>
        <div class="container  clearfix">
            <div class="pull-left">
                <address class="footer-content-info">
                    <h5>朗朗医疗投资有限公司</h5>
                    <p>集团总部热线 : <a href="4000-890-608">4000-890-608</a><br>
                        集团总部地址：广东省深圳市南山区高新南一道3号富诚大厦三楼</p>
                </address>
                <div class="share clearfix">
                    <a href="#">
                        <!-- <p><img src="images/code.png" alt="erweima"></p> -->
            ...
            <div class="pull-right">
                <ul class="footer-menu clearfix">
                    ...
                    <dl>
                        <img src="images/code.png" alt="erweima">
                        <p>微信公众号</p>
                    </dl>
                </ul>
            </div>
